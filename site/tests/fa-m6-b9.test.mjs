...
const C = require("../engine-contracts-v22.js");
...
{
  const ordered = [
    ["1 public-evidence repaired reference", fa.tokens.referenceReadingLine, /planning baseline/], // bq-3316 (2026-09-25): one name for ≈58%
     ...
     inside #fa-higher, after every ANSWER block, and leading the evidence-ranking stack. */
  {
       ...
       here and the assertion fails, which is the point. */
    {
      ...
      const FA_OPEN = '<section class="final-answer" id="final-answer" aria-label="Planning baseline">';
         ...
         that sends a reader to where the ranking legitimately lives. */
      {
           ...
           neither substitutes for the other. */
        {
          ...
          const EXPECTED = "ab4457ed2546d0679a0bb73717d730efd9f1c0f8310f05a531ae2819d3282e00"; /* previous d2df037c6690ab63… */
   ...
   while displaying a different number. The structural properties decide it. */
{
  ...
  //     escape `≈` is exactly what hid the live violation from four memo versions.
  {
    ...
    const html = readFileSync(join(ROOT, "site/index.html"), "utf8")
      + readFileSync(join(ROOT, "site/research/changelog.html"), "utf8");
    assert("T-7(d) the superseded readings survive as HISTORY in the methods box or the changelog",
...
/* ================= T-8 the guard extension (D-6d) ================= */
{
  ...
  assert("T-8 site/engine.js is in the basis guard's scanned SURFACES, typed `evaluated`",
    ...
    // rewrites the substring "../") cannot rewrite this test's expectation out from under it

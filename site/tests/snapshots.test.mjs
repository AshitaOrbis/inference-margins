...
// Run: node site/tests/snapshots.test.mjs — exits non-zero on any failure.
...
// review + council flagged must stay gone, and the honest replacements must stay present.
{
  ...
  const roofline = fs.readFileSync(new URL("../engine-roofline-v22.js", import.meta.url), "utf8");
  const engineData = fs.readFileSync(new URL("../engine-data-v22.js", import.meta.url), "utf8");
...
// package they publish, and preserve failing-test output for diagnosis.
{
  ...
  const receptionHtml = fs.readFileSync(
    new URL("../research/reception-synthesis.html", import.meta.url), "utf8");
  ...
  const servedSnapshots = fs.readFileSync(new URL("../tests/snapshots.test.mjs", import.meta.url), "utf8");

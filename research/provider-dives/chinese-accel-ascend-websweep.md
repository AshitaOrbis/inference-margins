...
> **CORRECTION (2026-07-10):** this sweep's "INT8 1,054 TFLOPS" figure for the 910C reproduces a typo in the CloudMatrix paper. Huawei's Atlas 800T A3 spec (12.0 POPS INT8 per 8-NPU server) and the paper's own tables give **1.504 POPS INT8 per NPU**, which the paper's prefill-efficiency arithmetic confirms. Superseded by the [GPT Pro Chinese-accelerator dive](https://margins.ashitaorbis.com/research/chinese-accel-gptpro.html); the calculator uses 1.504.

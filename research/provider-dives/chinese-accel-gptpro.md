...
> **CORRECTION (2026-08-21):** this dive makes **¥0.38/kWh** the *central* Chinese datacenter electricity price (§2.3, and the "Other owned-TCO defaults" line in §5). The ¥0.38 figure is a **western-hub** tariff and is not disputed — it is the wrong case to make central on a page about *serving* inference. Serving fleets sit in the coastal provinces, where delivered industrial power is **≈¥0.65/kWh (0.58–0.75) ≈ $0.097/kWh**: State Grid Jiangsu's tariff table (issued 2026-05-28, effective 2026-06) gives ¥0.5842/kWh energy at 110 kV plus a ¥44.8/kW·month demand charge = **¥0.6524/kWh delivered** at a 0.90 load factor, and OIES (Hove, *The China data centre advantage: hype versus reality*, Feb 2026) reports the IEA finding Chinese industrial customers pay prices "comparable or higher" than US ones, with coastal Jiangsu/Guangdong delivered at ¥0.6–0.75/kWh — against an EIA US industrial average of **$0.0871/kWh** (Electric Power Monthly Table 5.3, data May 2026). East-Data-West-Computing moves only 4–12% of energy use and cannot move the ~60% of load that is latency-bound, which is exactly what inference serving is. This dive did carry a coastal *scenario* (¥0.70) and its value is close to the measured figure; the defect is which case is **central**, not the numbers themselves. **So read ¥0.65/kWh (≈$0.097) as the central figure for a serving fleet, and ¥0.38 as the western training-hub case.** Effect, stated rather than implied: the correction raises the electricity term **+72%** ($0.0494 → $0.0849 per accelerator-hour at the calculator's PUE 1.25), which is **+2.5%** on H800 owned-TCO hourly cost and **−0.64 pp** on its margin — with the H100 falling the identical −0.64 pp, so the H800-vs-H100 comparison does not move at all, and on the calculator's default *rental* basis the change is **0.00 pp**. **No engine value changed by this correction:** the calculator's global electricity default remains $0.07/kWh (labelled "US industrial ≈$0.06–0.09", which the EIA figure confirms), and nothing in the engine consumes ¥0.38. Recorded in the [changelog](https://margins.ashitaorbis.com/research/changelog.html).
...
- Western-zone delivered electricity: Ulanqab ~¥0.35/kWh [CR]; Zhongwei ~¥0.36 [DISCLOSED]; Qingyang ≤¥0.40 [DISCLOSED] → **¥0.38/kWh central** **[CORRECTED 2026-08-21 — that is the WESTERN case; for a serving fleet the central is the coastal ¥0.65/kWh ≈ $0.097 — see the correction at the top of this page]**; subsidized domestic-chip projects **¥0.30 (¥0.25–0.36)**; coastal scenario ¥0.70 (0.60–0.85).
...
- Chip-only electricity at ¥0.38 + PUE 1.2: H800 $0.047/h; H20 $0.027/h; 910C $0.040/h — depreciation and utilization dominate, not power. **[CORRECTED 2026-08-21 — at the coastal serving central of $0.097/kWh and the same PUE 1.2 these are H800 $0.081/h; H20 $0.047/h; 910C $0.070/h. The closing sentence still holds: electricity is 4.3% of the H800's owned-TCO hour at the calculator's default.]**
...
**Other owned-TCO defaults:** electricity ¥0.38/kWh (0.35–0.45) **[CORRECTED 2026-08-21 — western case; the serving central is the coastal ¥0.65/kWh (0.58–0.75) ≈ $0.097 — see the top of this page]**, subsidized ¥0.30 (0.25–0.36); PUE 1.20 (1.12–1.30); facility $7.8/W (6.5–9.5); accelerator depreciation 4 yr (3–5); facility 15 yr (14–20).

...
2. **MLPerf DeepSeek SUT and LoadGen source code.** [DeepSeek-R1 SUT](https://github.com/mlcommons/inference/blob/main/language/deepseek-r1/mlperf/offline_sut.py); [LoadGen results implementation](https://github.com/mlcommons/inference/blob/main/loadgen/results.cc). These prove that the published token numerator is generated output rather than total input-plus-output. [cite: file turn10file0L215-L241] [cite: file turn6file0L88-L106]

# Grok 4.6 — GPT-6 Astra Pro estimate (2026-09-25)

**Provenance.** One GPT-6 Astra Pro research run (ChatGPT, model `gpt-6-pro`), request `pr-20260925T063700Z-042437`, answered 2026-09-25T07:28:32Z. It was given this calculator's input contract, the Claude Opus 4.x reference estimate and the live connector's scenario space, and asked to set every input for Grok 4.6 from public evidence. The answer is reproduced below verbatim except for three presentation changes: ChatGPT's interface citation markers are removed, as on every page of this annex; links into the research run's own sandbox (files no reader can open) keep their text and lose the dead target; and equations are set as preformatted text, with a space between a bracket and a parenthesis inside them so the renderer does not read a product as a link; its sources are cited by URL in the text (published text SHA-256 `f7490a095c4aaff4d37dff4f49de774858f214a681b22ddf3751e9f3109043ec`; as received, `10dd8e0e579d773ab445580eca088489c1696c2dfdcef2b49ff360c8110f8632`).

## What the site shows

| reading | value |
|---|---|
| **Card headline** — this calculator on the run's central inputs, at list | **~81%** (80.87%) |
| Span — the run's own low- and high-margin scenarios, same engine | 66%–89% (65.92% – 89.19%) |
| The run's own stated reading | 80.9% (65.9–89.2%) |
...
| `priceIn` | 2 | 2 | 2 |
| `priceOut` | 6 | 6 | 6 |
| `cacheReadMult` | 25 | 25 | 25 |
| `billCacheHit` | 60 | 50 | 70 |
| `batchShare` | 0 | 0 | 0 |
| `discount` | 0 | 0 | 0 |
| `blend` | `{"gb200":50,"gb300":50}` | `{"gb200":50,"gb300":50}` | `{"gb200":50,"gb300":50}` |
| `rentAbsLeg` | `{"gb200":2.1,"gb300":2.5}` | `{"gb200":2.1,"gb300":2.5}` | `{"gb200":2.1,"gb300":2.5}` |
| `util` | 65 | 55 | 70 |
| `stackMult` | 1 | 1 | 1 |
| `trendMonths` | 0 | 0 | 0 |
...
| traffic | 8:1, 60% cache | 6:1, 50% cache | 10:1, 70% cache |

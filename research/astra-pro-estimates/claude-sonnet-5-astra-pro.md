# Claude Sonnet 5 — GPT-6 Astra Pro estimate (2026-09-25)

**Provenance.** One GPT-6 Astra Pro research run (ChatGPT, model `gpt-6-pro`), request `pr-20260925T063700Z-19b839`, answered 2026-09-25T07:35:49Z. It was given this calculator's input contract, the Claude Opus 4.x reference estimate and the live connector's scenario space, and asked to set every input for Claude Sonnet 5 from public evidence. The answer is reproduced below verbatim except for three presentation changes: ChatGPT's interface citation markers are removed, as on every page of this annex; links into the research run's own sandbox (files no reader can open) keep their text and lose the dead target; and equations are set as preformatted text, with a space between a bracket and a parenthesis inside them so the renderer does not read a product as a link; its sources are cited by URL in the text (published text SHA-256 `49cf89bab97a23a5cbe45e560bc1348eb4bb322d6ee9dded5f825914402e7349`; as received, `270f2bac9907399396405f0d15937c2c67d082723031a7553d73162edc9552bc`).

## What the site shows

| reading | value |
|---|---|
| **Card headline** — this calculator on the run's central inputs, at list | **~84%** (83.52%) |
| Span — the run's own low- and high-margin scenarios, same engine | 74%–89% (73.99% – 88.76%) |
| The run's own stated reading | 83.5% (74.0–88.8%) |
...
| `rentAbsLeg` | `{"h100":2.5,"h200":3.8,"gb200":5,"gb300":6.5,"tpu7":2.7}` | `{"h100":2.5,"h200":3.8,"gb200":5,"gb300":6.5,"tpu7":2.7}` | `{"h100":2.5,"h200":3.8,"gb200":5,"gb300":6.5,"tpu7":2.7}` |
| `util` | 70 | 65 | 75 |
| `stackMult` | 1 | 1 | 1.1 |
| `trendMonths` | 0 | 0 | 0 |

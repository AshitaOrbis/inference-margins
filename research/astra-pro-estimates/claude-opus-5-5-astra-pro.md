# Claude Opus 5.5 — GPT-6 Astra Pro estimate (2026-09-25)

**Provenance.** One GPT-6 Astra Pro research run (ChatGPT, model `gpt-6-pro`), request `pr-20260925T060752Z-19c6fb`, answered 2026-09-25T06:41:28Z. It was given this calculator's input contract, the Claude Opus 4.x reference estimate and the live connector's scenario space, and asked to set every input for Claude Opus 5.5 from public evidence. The answer is reproduced below verbatim except for three presentation changes: ChatGPT's interface citation markers are removed, as on every page of this annex; links into the research run's own sandbox (files no reader can open) keep their text and lose the dead target; and equations are set as preformatted text, with a space between a bracket and a parenthesis inside them so the renderer does not read a product as a link; its sources are cited by URL in the text (published text SHA-256 `603f1b056b8819be10b62a3d5aef3a730aa7682c9d654a6433773049c780cad9`; as received, `8844366dd95539ad28216dcc8430c455a51e2cc5f504048c150322f6c17c21a0`).

## What the site shows

| reading | value |
|---|---|
| **Card headline** — this calculator on the run's central inputs, at list | **~78%** (78.49%) |
| Span — the run's own low- and high-margin scenarios, same engine | 68%–84% (67.92% – 83.98%) |
| The run's own stated reading | 78.5% (67.9–84.0%) |
| Same central inputs at the page's Reference traffic (15:1, 60% cache) — context, not the headline | ~80% |
...
| `active` | 200 | 300 | 150 |
| `total` | 2500 | 3000 | 2000 |
| `precision` | fp8 | fp8 | fp8 |
| `priceIn` | 4 | 4 | 4 |
| `priceOut` | 20 | 20 | 20 |
| `cacheReadMult` | 5 | 5 | 5 |
| `billCacheHit` | 85 | 85 | 85 |
| `batchShare` | 0 | 0 | 0 |
| `discount` | 0 | 0 | 0 |
| `blend` | `{"h200":10,"gb200":35,"gb300":20,"tpu7":35}` | `{"h200":10,"gb200":35,"gb300":20,"tpu7":35}` | `{"h200":10,"gb200":35,"gb300":20,"tpu7":35}` |
| `rentAbsLeg` | `{"h200":3.5,"gb200":5,"gb300":6,"tpu7":2.7}` | `{"h200":3.5,"gb200":5,"gb300":6,"tpu7":2.7}` | `{"h200":3.5,"gb200":5,"gb300":6,"tpu7":2.7}` |
| `util` | 65 | 60 | 70 |
| `stackMult` | 1 | 1 | 1 |
| `trendMonths` | 0 | 0 | 0 |
...
| traffic | 30:1, 85% cache | 30:1, 85% cache | 30:1, 85% cache |

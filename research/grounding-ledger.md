...
> **What this is:** every parameter the calculator's presets pin, with value, source and evidence label, generated directly from the deployed preset registry (`engine.js` v2.1.6-2026-07-15) and its dossier annotations — so this page cannot drift from what the calculator actually computes.
...
| TPU v7 Ironwood | 4.61 | 192 | 7.37 | 4.2 | 35000 | 0.13 | 0.4 | Google's inference TPU (GA Mar 31, 2026): 4,614 TF FP8 ≈ B200-class, 9,216-chip pods. Anthropic committed up to ~1M TPUs (Oct 2025). Google-internal cost unknown — estimates. |
| Trainium2 | 1.3 | 96 | 2.9 | 1.5 | 15000 | 0.055 | 0.3 | GA Dec 2024. Project Rainier launched with ~500k Trainium2 for Anthropic (activated ~Nov 2025); Anthropic reported >1M Trainium2 in use across AWS by Apr 2026. Cheap per chip, weaker software stack — estimates; NO public serving anchor. |
| Trainium3 | 2.51 | 144 | 4.9 | 2.2 | 20000 | 0.08 | 0.34 | GA Dec 2025: 144-chip UltraServers, 362 PF FP8 ⇒ 2.51 PF/chip, 144GB HBM3e. AWS's aggressive cost-per-token play — pricing estimates. |

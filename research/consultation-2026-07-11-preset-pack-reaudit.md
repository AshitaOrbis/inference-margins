...
> **Provenance class: author-model re-emission, not an independently verified original.** The original pack's full row set lived in conversation-sandbox files that expired. On 2026-07-11 the same GPT-5.6 Pro project was asked to re-emit the pack inline; it reports having located its own retained "22:29 UTC final export" and re-emitting it exactly (run 21m0s, Pro-verified, `completion_path: api`, [conversation](https://chatgpt.com/g/g-p-6a42f0b0f46081919a65018455ee56dd/c/6a51a7c0-eb28-83e8-b98a-1f8fb4e382a9)). That exactness claim is the model's own and cannot be independently byte-verified — which is why the site's authoritative parameter record is the [adopted grounding ledger](grounding-ledger.html), generated from the deployed preset registry. **Where this page and the ledger differ, the ledger wins.**

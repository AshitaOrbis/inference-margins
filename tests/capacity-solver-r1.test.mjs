...
// Run: node tests/capacity-solver-r1.test.mjs
...
{ const lengths = require("../site/engine-roofline-v22.js")
...
{ let threw = false; const R = require("../site/engine-roofline-v22.js");

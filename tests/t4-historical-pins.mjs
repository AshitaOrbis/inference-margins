...
const ED_LIVE = require("../site/engine-data-v22.js");
...
export function loadPreT4Module(spec, fromDir = new URL("../site/", import.meta.url).pathname) {
...
export function withPreT4Registry(fn) {
  const path = require.resolve("../site/engine-data-dc-v1.js");

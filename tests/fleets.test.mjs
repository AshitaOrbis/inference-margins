...
// Run: node tests/fleets.test.mjs
...
{ assert("B′1 retirement: the width-case selection channel is no longer exported",
  ...
  const gbSens = require("../site/engine-roofline-v22.js").resolveHwRoofline("gb200").row.topologySensitivity;
...
{ const R2 = require("../site/engine-roofline-v22.js");

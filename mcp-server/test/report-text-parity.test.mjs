...
/* 2026-09-20 im-vet-six-repairs ROUND 2 (completion-gate FAIL) — THREE AUTHORIZED DELTAS:
   ...
   what moved them. */
/* 2026-09-25 im-legibility-merge-enact-0925 (bq-3316, enacting the bq-1141 tri-model legibility merge) —
   THREE AUTHORIZED DELTAS: report-s5, report-s10 and front-page. PRESENTATION + COPY ONLY, no number moved.
     * report-s5: one phrase — "the ~58% public-evidence reference reading" -> "the ~58% planning baseline"
       (one name for the 58% reading, M3 builder half).
     * report-s10: the six provider summaries' membership clause in reader words — "renderable at declared
       serving topology" -> "fit their declared serving setup" (M11); the counts are unchanged and still
     ...
     * front-page: the one-sentence standfirst (M4) with the rest of it moved into the methods box, the
       ...
       slices above.
   Confirmed by the COMPILED runtime extractor at DUMP_PARITY_HASHES=1 after a fresh MCP build, enumerated id
   by id: EXACTLY report-s5, report-s10 and front-page move (norm and raw); the other eight ids are
   byte-identical to their declared expectations. The bedcc23 capture stays BYTE-FROZEN as designed. */
/* 2026-09-25 im-astra-pro-estimates-0925 (bq-3351; owner ruling
   d-20260925-im-astra-pro-estimates-category-and-drop-same-assumption-section) — TWO AUTHORIZED DELTAS:
   report-s10 and front-page. The §10 "Same-assumption scenario outputs" one-lens table is removed (its
   last text moved verbatim to the changelog) and the "Astra Pro estimates" sub-category is added: an
   intro, a chart container and fourteen generated cards whose every figure is astraProReplay of a
   recorded operating point (face == replay pinned by tests/astra-pro-estimates.test.mjs), plus one
   pointer sentence in the §10 intro. front-page is the whole page, so it carries exactly the report-s10
   change. Confirmed by the COMPILED runtime extractor at DUMP_PARITY_HASHES=1 after a fresh MCP build,
   id by id: EXACTLY report-s10 and front-page move (norm and raw); report-s1..s9 are byte-identical to
   their declared expectations. The bedcc23 capture stays BYTE-FROZEN as designed. */
